...
import {taskApi, TaskPriorities, TaskStatuses, UpdateTaskModelType} from '../api/task-api';
...
export const CreateTasks = () => {
    ...
    function createTask() {
        taskApi.createTask(inputValueID, inputValue)
            .then(res => {
                setState(res.data)
            })
    }
...
export const DeleteTask = () => {
    ...
    function deleteTask() {
        taskApi.deleteTask(inputValueID,inputValue)
            .then(res => {
                setState(res.data)
            })
    }
